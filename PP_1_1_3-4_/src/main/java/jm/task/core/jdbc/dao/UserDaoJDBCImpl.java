...
public class UserDaoJDBCImpl implements UserDao {
    ...
    public void createUsersTable() {
        try (Statement statement = connection.createStatement()) {
            ...
            String createUsersTable = "CREATE TABLE IF NOT EXISTS `testnew`.`users` (`id` BIGINT NOT NULL AUTO_INCREMENT,`name` VARCHAR(100) NOT NULL,`lastName` VARCHAR(100) NULL,`age` INT(3) NOT NULL, PRIMARY KEY (`id`))";
